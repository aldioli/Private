...
const _faqs = [
  _Faq(
    question: 'كيف أفتح حساباً في Beepay؟',
    answer:
  ...
  _Faq(
    ...
    answer:
        'التحويل بين محافظ Beepay مجاني تماماً. قد تُطبق رسوم رمزية على السحب النقدي حسب الوكيل.',
  ...
  _Faq(
    ...
    answer:
        'اذهب إلى "سحب" من الخدمات السريعة، أدخل المبلغ واختر طريقة السحب. يمكنك السحب عبر وكيل Beepay أو التحويل إلى حسابك البنكي.',
    icon: Icons.money_outlined,
    color: AppColors.error,
  ),
  _Faq(
    question: 'هل تطبيق Beepay آمن؟',
    answer:
